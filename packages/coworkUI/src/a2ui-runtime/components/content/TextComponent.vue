...
.a2-text :deep(code) {
  ...
  padding: 0 var(--swt-space-size-4);
  border-radius: var(--swt-radius-size-normal);
}
.a2-text :deep(pre) {
  background: var(--a2-code-bg, var(--swt-color-bg-secondary));
  color: var(--a2-code-fg, var(--swt-color-text-primary));
